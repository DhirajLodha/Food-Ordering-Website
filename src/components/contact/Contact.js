...
function Contact() {
  return (
    <>
      <section
        className="u-clearfix u-gradient u-valign-middle-md u-section-1-contact"
        id="carousel_f143"
        style={{ marginTop: "100px" }}
      >
        <div className="u-clearfix u-sheet u-sheet-1-contact">
          <div className="u-expanded-width u-list u-list-1-contact">
            <div className="u-repeater u-repeater-1">
              <div className="u-align-center u-container-style u-list-item u-repeater-item u-white u-list-item-1">
                <div className="u-container-layout u-similar-container u-valign-top u-container-layout-1">
                  ...
                  <p className="u-text u-text-2">
                    {" "}
                    207, 1st Floor, CMR Road, 3rd
                    <br />
                    HRBR Layout, Kalyan Nagar, Surat - 395010
                  </p>
                </div>
              </div>
              <div className="u-align-center u-container-style u-list-item u-repeater-item u-white u-list-item-2">
                <div className="u-container-layout u-similar-container u-valign-top u-container-layout-2">
                  ...
                  <p className="u-text u-text-4">+91 9876543210</p>
                </div>
              </div>
              <div className="u-align-center u-container-style u-list-item u-repeater-item u-white u-list-item-3">
                <div className="u-container-layout u-similar-container u-valign-top u-container-layout-3">
                  ...
                  <h5 className="u-text u-text-5">Fax</h5>
              ...
              <div className="u-align-center u-container-style u-list-item u-repeater-item u-white u-list-item-4">
                <div className="u-container-layout u-similar-container u-valign-top u-container-layout-4">
                  ...
                  <h5 className="u-text u-text-7">Email</h5>
                  <p className="u-text u-text-8">
                    <a
                      href="mailto:franchise@thepizzavilla.in"
                      className="u-active-none u-border-1 u-border-active-black u-border-hover-black u-border-palette-4-dark-2 u-btn u-button-link u-button-style u-hover-none u-none u-text-active-black u-text-hover-black u-text-palette-4-dark-1 u-btn-1"
                    >
                      franchise@thepizzavilla.in
                    </a>
                  </p>
                </div>
              </div>
          ...
          <div className="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
            <div className="u-layout">
              <div className="u-layout-row">
                <div className="u-align-left u-black u-container-style u-layout-cell u-left-cell u-size-32 u-layout-cell-1">
                  <div className="u-container-layout u-container-layout-5">
                    <h3 className="u-text u-text-body-alt-color u-text-default u-text-9">
                      Contact Info
                    </h3>
                    <div className="u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
                      ...
                      >
                        <div className="u-form-email u-form-group u-form-partition-factor-2">
                          <label
                            for="email-319a"
                            className="u-label u-text-body-alt-color u-label-1"
                          >
                            Email
                          </label>
                          <input
                        ...
                        <div className="u-form-group u-form-name u-form-partition-factor-2">
                          <label
                            for="name-319a"
                            className="u-label u-text-body-alt-color u-label-2"
                          >
                            Name
                          </label>
                          <input
                        ...
                        <div className="u-align-left u-form-group u-form-submit">
                          <a
                            href="/"
                            className="u-border-none u-btn u-btn-submit u-button-style u-hover-palette-2-light-1 u-palette-2-base u-btn-2"
                          >
                            Submit
                          </a>
                          <input
                ...
                <div className="u-black u-container-style u-layout-cell u-right-cell u-size-28 u-layout-cell-2">
                    ...
                    <div className="u-expanded u-grey-light-2 u-map">
                      <div className="embed-responsive">
                        <iframe
                          ...
                          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d50935.51930663628!2d72.81082330095627!3d21.139800006407132!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be051cc2121e169%3A0xe5144dafaf376dd!2sUdhana%2C%20Surat%2C%20Gujarat!5e1!3m2!1sen!2sin!4v1660414612451!5m2!1sen!2sin"
                        ></iframe>
                      </div>
                    </div>
                  </div>
